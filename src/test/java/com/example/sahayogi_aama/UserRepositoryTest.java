...
public class UserRepositoryTest {
    ...
    public void saveUserTest() {
        ...
        User user = User.builder()
                .fullname("Basanta Adhikari")
                .email("adhikaribasan@gmail.com")
                .phoneNo("9840118763")
                .password("Basanta123")
                .build();
    ...
    public void updateUserTest() {
        ...
        Assertions.assertThat(userUpdated.getFullname()).isEqualTo("Rahul Adhikari");
...
//        User user1 = userRepo.findById(user.getId()).get();
        ...
        User user2 = null;
        Optional<User> optionalUser = userRepo.findByEmail("basanta@gmail.com");
